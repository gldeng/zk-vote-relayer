...
namespace ZkVoteRelayer.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("ZkVoteRelayer") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "ZkVoteRelayer", DisplayName = "ZkVoteRelayer API", Resources = { "ZkVoteRelayer" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["ZkVoteRelayer_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["ZkVoteRelayer_Swagger:RootUrl"]?.TrimEnd('/');
